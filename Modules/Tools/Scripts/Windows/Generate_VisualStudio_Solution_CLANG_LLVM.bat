...
:: Rebuild Project
cmake -G "Visual Studio 15 2017 Win64" -T"llvm" -DANNMNISTNG_USE_CONFIG:BOOL=ON -DANNMNISTNG_EXPLICIT_COMPILER_ID:STRING="CLANG" -DANNMNISTNG_EXPLICIT_HOST_ID:STRING="WIN" ../Source

:: Create symbolic link to solution in root
cd ../../
IF EXIST ANNMNISTNG_CLANG_LLVM.sln ( del ANNMNISTNG_CLANG_LLVM.sln )
mklink "ANNMNISTNG_CLANG_LLVM.sln" "ANNMNISTNG\Generated_VisualStudio_Solution_CLANG_LLVM\ANNMNISTNG.sln"
